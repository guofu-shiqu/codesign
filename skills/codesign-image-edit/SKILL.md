...
6. Insert the revised image beside the original with CoDesign MCP.
   ...
   ```json
   {
     ...
     "codesignAnnotationSourceShapeId": "<selected source image or frame id>",
     "codesignAnnotationScreenshot": "<source screenshot file name when available>"
   }
   ```
...
7. Save through CoDesign.
   ...
   ```json
   {
     ...
     "codesignUrl": "http://127.0.0.1:43217",
